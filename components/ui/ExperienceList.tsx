  ...
  return (
    <div className="flex flex-col">
      ...
      {experience.map(({ years, company, isActive }) => (
        <div key={years} className="grid grid-cols-[72px_1fr] gap-x-6 md:grid-cols-[100px_1fr] md:gap-x-[52px] py-[3px] border-b border-portfolio-stroke/50 last:border-b-0">
